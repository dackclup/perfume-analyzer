...
export const RULES = [
  ...
  // ── Furanones / maltol family (caramel, sweet, gourmand)
  {
    ...
    families: ['gourmand'],
    facets: ['caramellic', 'sweet'],
    type: 'Caramellic / Sweet',
    strength: 'High',
    note: 'Middle / Base',
  },
  {
  ...
  // ── Sulfur-containing (gourmand, savory, blackcurrant)
  {
    ...
    families: ['gourmand'],
    facets: ['sulfurous', 'savory'],
    type: 'Sulfurous / Savory',
    strength: 'Very High',
    note: 'Top',
  },
  ...
  // ── Phenols (vinylphenol, hydroxybenzene variants, guaiacol-likes)
  {
    ...
    families: ['spicy', 'balsamic'],
    facets: ['phenolic', 'smoky', 'medicinal'],
    type: 'Phenolic / Smoky',
    strength: 'High',
    note: 'Middle / Base',
  },
  ...
  // ── Coumarin family (hay, tonka, fougère core)
  {
    ...
    families: ['gourmand', 'herbal'],
    facets: ['coumarinic', 'hay', 'tonka'],
    type: 'Coumarinic / Hay',
    strength: 'Medium',
    note: 'Middle / Base',
  },
  ...
  // ── Cinnamic / hexylcinnamic family (florals)
  {
    ...
    facets: ['floral', 'jasmine', 'spicy'],
    type: 'Floral / Cinnamic',
    strength: 'Medium',
    note: 'Middle',
  },
  {
  ...
  // ── Mint / camphoraceous (carvone, menthol, etc.)
  {
    ...
    families: ['camphoraceous', 'herbal'],
    facets: ['mint', 'camphor', 'herbal'],
    type: 'Mint / Camphoraceous',
    strength: 'High',
    note: 'Top / Middle',
  },
  ...
  {
    re: /\bsalicylate\b/i,
    families: ['balsamic', 'floral'],
    facets: ['salicylate', 'balsamic', 'sun-tan'],
    type: 'Balsamic / Salicylate',
    strength: 'Medium',
    note: 'Middle / Base',
  },
  ...
  // ── Ambergris synthetics
  {
    ...
    facets: ['ambergris', 'dry-amber', 'woody'],
    type: 'Ambery / Woody',
    strength: 'High',
    note: 'Base',
  },
  ...
  // ── Sandalwood synthetics
  {
    ...
    families: ['woody'],
    facets: ['sandalwood', 'creamy-wood'],
    type: 'Woody / Sandalwood',
    strength: 'Medium',
    note: 'Base',
  },
  ...
  },
  {
    ...
    families: ['floral'],
    facets: ['muguet', 'lily-of-the-valley', 'floral'],
    type: 'Floral / Muguet',
    strength: 'Medium',
    note: 'Middle',
  },
  ...
  // ── Indolic / animalic
  {
    ...
    families: ['floral'],
    facets: ['indolic', 'animalic', 'narcotic'],
    type: 'Indolic / Animalic',
    strength: 'Very High',
    note: 'Middle / Base',
  },
  ...
  // ── Lactones (fruity, creamy, peach)
  {
    ...
    facets: ['lactonic', 'peach', 'creamy'],
    type: 'Lactonic / Fruity',
    strength: 'Medium',
    note: 'Middle / Base',
  },
  {
  ...
  // ── Aldehydes (citrus / fatty / floral)
  {
    ...
    families: ['citrus', 'aldehydic'],
    facets: ['citrus', 'lemon', 'aldehydic'],
    type: 'Aldehydic / Citrus',
    strength: 'Very High',
    note: 'Top',
  },
  {
    ...
    families: ['aldehydic'],
    facets: ['aldehydic', 'fatty', 'soapy'],
    type: 'Aldehydic / Fatty',
    strength: 'Very High',
    note: 'Top',
  },
  {
    re: /\b(hexenal|hexen-1-al|2[\s-]?hexenal|3[\s-]?hexenal|pent[\s-]?2[\s-]?enal|hex[\s-]?2[\s-]?enal|oct[\s-]?2[\s-]?enal)\b/i,
    families: ['green', 'aldehydic'],
    facets: ['green', 'leafy', 'aldehydic'],
    type: 'Green / Leafy',
    strength: 'Very High',
    note: 'Top',
  },
  {
    ...
    families: ['aldehydic', 'spicy'],
    facets: ['aldehydic', 'spicy', 'anise'],
    type: 'Aldehydic / Spicy',
    strength: 'High',
    note: 'Middle',
  },
  {
    re: /[a-z]+\s*-?\s*\d?\s*,?\s*\d?\s*-?\s*dienal\b/i,
    families: ['aldehydic', 'green'],
    facets: ['aldehydic', 'green', 'fatty'],
    type: 'Aldehydic / Green',
    strength: 'Very High',
    note: 'Top',
  },
  {
  ...
  // ── Linalool / floral terpenes
  {
    ...
    families: ['floral', 'herbal'],
    facets: ['floral', 'terpenic', 'rosy'],
    type: 'Floral / Terpenic',
    strength: 'Medium',
    note: 'Top / Middle',
  },
  ...
  // ── Sesquiterpenes (cubebene, caryophyllene, humulene, bisabolene)
  {
    ...
    families: ['woody', 'herbal'],
    facets: ['woody', 'spicy', 'green'],
    type: 'Woody / Sesquiterpene',
    strength: 'Medium',
    note: 'Middle / Base',
  },
  ...
  // ── Acetophenone family (aromatic ketones — sweet, hawthorn-like)
  {
    ...
    families: ['floral'],
    facets: ['hawthorn', 'aromatic-ketone', 'sweet'],
    type: 'Aromatic / Ketone',
    strength: 'Medium',
    note: 'Middle',
  },
  ...
  // ── Citrus monoterpenes
  {
    ...
    facets: ['citrus', 'terpenic', 'fresh'],
    type: 'Citrus / Terpenic',
    strength: 'High',
    note: 'Top',
  },
  ...
  // ── Acetals / ortho esters (typically green / fresh)
  {
    ...
    families: ['green', 'fruity'],
    facets: ['green', 'fresh', 'clean'],
    type: 'Green / Fresh',
    strength: 'Medium',
    note: 'Top / Middle',
  },
  ...
  // ── Misc aromatics (anisole, veratrole) — ether-aromatic notes
  {
    ...
    families: ['herbal'],
    facets: ['anise', 'sweet-aromatic'],
    type: 'Anisic / Aromatic',
    strength: 'Medium',
    note: 'Middle',
  },
...
export function searchString(entry) {
  const parts = [entry.name || '', entry.iupac || '', ...(entry.synonyms || [])];
...
export function applyClassification(entry, match) {
  if (!entry.classification)
    entry.classification = { primaryFamilies: [], secondaryFamilies: [], facets: [] };
  if (!entry.classification.primaryFamilies?.length)
    entry.classification.primaryFamilies = [...match.families];
